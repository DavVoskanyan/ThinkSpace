class SideBarCreator {
    ...
    #SIDEBAR_SECTION_LINKS = {
        'scheduler':'/pages/SchedulePage/schedule.html',
        'all notes' : '/pages/AllNotes/allNotes.html',
        'analytics' : '/pages/AnalyticsPage/analytics.html',
        'history' : '/pages/HistoryPage/history.html',
        'settings' : '/pages/SettingsPage/settings.html'};
